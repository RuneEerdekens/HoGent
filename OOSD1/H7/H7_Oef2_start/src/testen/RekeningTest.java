...
public class RekeningTest
{
	...
	@Test
	public void maakRekening_houderEnkelBlankos_werptException()
	{
		Assertions.assertThrows(IllegalArgumentException.class, () -> new Rekening(232346789122L, "  "));
	}
	
	@Test
	public void maakRekening_houderNull_werptException()
	{
		Assertions.assertThrows(IllegalArgumentException.class, () -> new Rekening(232346789122L, null));
	}
